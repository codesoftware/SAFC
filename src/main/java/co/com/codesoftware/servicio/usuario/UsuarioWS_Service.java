 ...
 * 
 */
@WebServiceClient(name = "UsuarioWS", targetNamespace = "http://usuario.servicio.codesoftware.com.co/", wsdlLocation = "http://localhost:7777/SIGEMCOWS/UsuarioWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USUARIOWS_QNAME = new QName("http://usuario.servicio.codesoftware.com.co/", "UsuarioWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7777/SIGEMCOWS/UsuarioWS?wsdl");
    ...
    public UsuarioWS getUsuarioWSPort() {
        return super.getPort(new QName("http://usuario.servicio.codesoftware.com.co/", "UsuarioWSPort"), UsuarioWS.class);
    }
    ...
    public UsuarioWS getUsuarioWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://usuario.servicio.codesoftware.com.co/", "UsuarioWSPort"), UsuarioWS.class, features);
    }
